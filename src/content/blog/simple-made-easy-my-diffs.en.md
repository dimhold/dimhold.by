...
Grepping for the identifier is the only mechanical count I have and it undercounts badly. The dash rule is written out in prose in 6 documents as well as the code. The engagement bait rule is in 5. A rule restated in prose does not announce that it has a twin, so how wide this goes I cannot say.
