...
На сервере с Linux 6.8 и `tcp_syn_retries` по умолчанию равным 6 оно ждало 135.3 секунды и упало с `ETIMEDOUT`. Это число не выбирала ни одна строка моего кода.
