...
На серверы з Linux 6.8 і `tcp_syn_retries` па змаўчанні роўным 6 яно чакала 135.3 секунды і ўпала з `ETIMEDOUT`. Гэты лік не выбірала ніводная радок майго кода.
