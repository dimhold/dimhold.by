...
<figcaption>Загаловак таксама ідзе на ўваход хэша. Палічыць хэш ад аднаго змесціва можна, але імя выйдзе іншае. У гэтым рэпазіторыі такое імя не сустракаецца.</figcaption>
</figure>
...
<figcaption>Гэта вынік пяці выклікаў пламбінга. Індэкс гэта адзінае, чаго mktree не чапае. Вывад status быў якраз пра гэта.</figcaption>
</figure>
