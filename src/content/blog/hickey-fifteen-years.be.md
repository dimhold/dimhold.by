...
У жывым кодзе 16.7 разгалінавання на 100 радкоў. У скрыптах, што выкідаюцца, 14.6. Медыяны па файлах кажуць тое ж, 17.0 супраць 15.0, значыць суму не цягне адзін тлусты файл. На адзіным радку яго табліцы, які ўсё яшчэ чагосьці мне каштуе, шчыльнейшым аказаўся той код, якому трэба выжыць, то бок наадварот. Разгалінаванне тут гэта `if`, тэрнарнік, `switch` і кароткае замыканне, узятыя з сінтаксічнага дрэва. Тыдзень таму я публікаваў па гэтым жа рэпазіторыі 21.9, лікам па ключавых словах, па іншым наборы шляхоў і разам з цыкламі.
