...
export const en: Dictionary = {
  ...
  games: {
    ...
    description:
      'Belarusian folk games you can play right in the browser. Each one says who recorded it, where and when — and honestly, what in it is Belarusian and what is shared with the neighbours.',
    lede: 'Folk games you can play right here. Games that exist only in Belarus are almost nonexistent — Belarusian ethnographers are the first to say so. What does exist is how people played here: their own words, their own songs, the things they held in their hands and the day of the year they held them.',
    framing:
      'In their mechanics these games are mostly shared with Russia, Ukraine and Poland. What is their own is the language, the song, the implement and the season. That is a better story than “unique”, and it has one great advantage: it is true.',
    rulesLabel: 'Three rules of this section',
    rules: [
      'Every game names its source: who recorded it, where and when.',
      'Nothing beyond what the sources say. “Only in Belarus” appears only where the record itself says it.',
      'Nothing filled in quietly. Where the record is silent and a number had to be chosen, the page says we chose it.',
    ],
    ...
    items: [
      {
        ...
        name: '«Ката пячы»',
        gloss:
          'A cat is shaped out of buns and hung from the ceiling. You are lifted to it on a pitchfork and jump to bite a piece off, while everyone around shoves you. Whoever bites off the tail wins.',
        status: 'live',
      ...
      },
      {
        ...
        name: '«Лянок»',
        gloss:
          'Eight things done to flax — pulling, threshing, spreading, braking, weaving, bleaching, cutting, sewing — each with its own line of the song, sung back on the beat. The cloth you end up with is a real ornament.',
        status: 'planned',
      },
      {
        slug: 'pannachka',
        name: '«Панначка»',
        gloss:
          'Girls stand in a ring, each holding a lit candle. The task is to blow out your neighbour’s flame and keep your own. Nobody is eliminated: the last flame goes round the ring and lights all the others again.',
        status: 'planned',
      },
      {
        slug: 'hrahi',
        name: '«Грахі»',
        gloss:
          'A ball is rolled along a row of holes. Miss, and a sin drops into your hole; hit, and it drops into somebody else’s. And whoever carries sins gets fewer throws: the guiltier you are, the less right you have to punish.',
        status: 'planned',
      },
      {
        ...
        gloss:
          'The Kalady wedding game — the one game scholars call Belarus’s own. You are the matchmaker, pairing off the whole house couple by couple, and the song leads the game: what is sung is what happens.',
        status: 'planned',
      },
    ],
    kata: {
      ...
      title: '«Ката пячы» — bake a cat, bite off its tail',
      description:
        'On 27 November in Skirmantava a cat is shaped out of buns, hung from the ceiling and bitten at from a pitchfork; whoever bites off the tail wins. Here you bake the cat first — and the cat you bake is the one you will have to bite.',
      kicker: '27 November · аг. Скірмантава · State List 33АК000117',
      lede: 'On the evening before the fast a cat is shaped out of buns and hung from the ceiling on a cord. One by one the players are lifted to it on a pitchfork and jump to bite a piece off, while the rest do their best to knock them down. Whoever bites off the tail wins. Here it all starts earlier, at the oven: the cat has to be baked first, and whatever comes out of the oven is what you will have to bite.',
      howLabel: 'How to play',
      how: [
        'Hold, and a ball of dough tears off from the trough. The bigger it is, the wider the bite later; a small one is harder to catch, and it burns faster in the oven.',
        'One trough for all six buns. The sixth is the tail, and the tail decides everything — leave it some dough.',
        'Let go, and the ball goes into the oven. Press when it turns golden. Raw is heavy and slippery; burnt is wide and crisp, but light as air.',
        'Then the cat is hung, and the real thing begins. A heavy cat swings lazily, a light one goes wild — and with every piece bitten off it gets lighter.',
      ],
      start: 'Knead',
      again: 'Again',
      ...
      shove: 'a shove!',
      sceneAlt:
        'A cat shaped out of buns hangs on a cord from the ceiling beam. Below it a boy on a pitchfork; beside them an oven and a trough of dough; around them the rest of the house.',
      ...
      msg: {
        ...
        baked: '{piece}: {bake}.',
        tailNext: 'The last one is the tail, and the tail decides everything. Dough left: {n}.',
        doughOut: 'The trough is scraped clean — whatever is left is what you bake.',
        hung: 'The cat is baked and hung. Now bite.',
        ready: 'Bite: {piece}.',
        hit: 'Got it! The cat is lighter now — and faster.',
        miss: 'Missed. That piece went to somebody else.',
        tail: 'Only the tail is left, and the cord is flying like never before. Tries: {n}.',
        tailMiss: 'Missed. Tries left: {n}.',
        win: 'You bit off the tail. The game is yours.',
        lose: 'The tail went to somebody else. Until next 27 November, then.',
      },
      advisors: {
        hanna: {
          name: 'Hanna',
      ...
      epilogue: {
        win: 'The tail is yours. The cat is eaten to the last crumb, and the house goes quiet.',
        lose: 'The tail went to somebody else. The cat is eaten all the same, to the last crumb.',
        calendar:
          'Tomorrow morning the Piĺipaŭka fast begins. It takes away meat, and games along with it — all the way to Kalady.',
        docLabel: 'What the record actually says',
        facts: [
          'The rite «Ката пячы» was inscribed on the State List of Historical and Cultural Values in 2017, entry 33АК000117.',
          'аг. Скірмантава, Dziaržynsk district.',
          'Kept by the Redźka family and the village ensembles «Сваякі» and «Весялуха», every year since 1993.',
        ],
        invented:
          'Hanna, Symon and Alesik are ours. The list records the rite, not the people: the names, the arguing and every piece of advice were made up here.',
      },
      sourceLabel: 'Source',
      source:
        'State List of Historical and Cultural Values of the Republic of Belarus, entry 33АК000117, inscribed in 2017: the rite «Ката пячы», аг. Скірмантава, Dziaržynsk district. Kept by the Redźka family and the village ensembles «Сваякі» and «Весялуха», every year since 1993.',
      honestyLabel: 'How Belarusian it is',
      honesty:
        'One of the few games where the claim to uniqueness actually holds: no Russian, Ukrainian or Polish counterpart turned up under any name. But the rite is not nationwide either — it belongs to one village. The list records Skirmantava, and that is exactly how it is shown here.',
      calendarLabel: 'Why 27 November',
      calendar:
        'It is the eve of the Piĺipaŭka fast. The food that evening is deliberately rich: the fast starts in the morning, and it bans meat — and games along with it.',
      choicesLabel: 'What we made up ourselves',
      choices:
        'From the record: the cat is baked out of buns, hung from the ceiling, reached on a pitchfork, the others shove, and the tail decides the game. Everything with a number in it is ours: how much dough the trough holds, what a bun’s size means for the bite, how raw and burnt change the swing, how many tries the tail gives. The baking here is its own half of the game, and the record has nothing of the kind: there the buns are simply baked, not competed over. The three at the table are ours too. Hanna, Symon and Alesik are invented, and they contradict each other on purpose: variants of the tradition really do disagree, and none of the three is more right than the others.',
      back: 'all games',
    },
  },
  toy: {
...
export const ru: Dictionary = {
  ...
  games: {
    ...
    description:
      'Белорусские народные игры, в которые можно сыграть прямо в браузере. У каждой — кто записал, где и когда, и честно: что в ней своё, а что общее с соседями.',
    lede: 'Народные игры, в которые можно сыграть прямо здесь. Игр, которые есть только в Беларуси, почти нет — об этом первыми говорят сами белорусские этнографы. Зато есть то, как играли здесь: свои слова, свои песни, свои вещи в руках и свой день в календаре.',
    framing:
      'По механике эти игры во многом общие с русскими, украинскими и польскими. Своё в них — язык, песня, инвентарь и время года. Такая история интереснее разговоров об уникальности, и главное — она правдива.',
    rulesLabel: 'Три правила раздела',
    rules: [
      'У каждой игры назван источник: кто записал, где и когда.',
      'Ничего сверх того, что есть в источниках. «Только в Беларуси» сказано лишь там, где это сказано в записи.',
      'Ничего не додумано молча. Если запись молчит и число пришлось выбрать самим — страница так и говорит.',
    ],
    ...
    items: [
      {
        ...
        name: '«Ката пячы»',
        gloss:
          'Кота лепят из булок и вешают под потолок. Ты поднимаешься к нему на вилах и прыгаешь, чтобы откусить кусок, а все вокруг тебя толкают. Кто откусил хвост — тот и выиграл.',
        status: 'live',
      ...
      },
      {
        ...
        name: '«Лянок»',
        gloss:
          'Восемь дел со льном — брать, молотить, стелить, мять, ткать, белить, кроить, шить — и на каждое своя строчка песни, в такт. А полотно в конце сложится в настоящий орнамент.',
        status: 'planned',
      },
      {
        slug: 'pannachka',
        name: '«Панначка»',
        gloss:
          'Девушки стоят кругом, у каждой в руках свеча. Надо задуть соседкину и уберечь свою. Но никто не выбывает: последний огонёк идёт по кругу и зажигает все остальные заново.',
        status: 'planned',
      },
      {
        slug: 'hrahi',
        name: '«Грахі»',
        gloss:
          'Мяч катят вдоль ряда лунок. Промахнулся — грех ложится в твою лунку, попал — в чужую. А кто носит на себе грехи, тому и бросков дают меньше: чем больше вины, тем меньше права наказывать.',
        status: 'planned',
      },
      {
        slug: 'zanicba-cyareski',
        name: '«Жаніцьба Цярэшкі»',
        gloss:
          'Колядная игра в свадьбу — единственная, которую исследователи называют только белорусской. Ты — свацця, сваха, и сводишь всю хату в пары, одну за другой. А ведёт игру песня: что спели, то и случилось.',
        status: 'planned',
      },
    ],
    kata: {
      name: '«Ката пячы»',
      gloss: 'печь кота',
      title: '«Ката пячы» — белорусская игра: испечь кота и откусить хвост',
      description:
        '27 ноября в Скирмантове кота лепят из булок, вешают под потолок и кусают с вил; кто откусил хвост, тот выиграл. Здесь кота сначала надо испечь — и кусать потом будешь того, которого испёк.',
      kicker: '27 лістапада · аг. Скірмантава · Дзяржаўны спіс 33АК000117',
      lede: 'Вечером накануне поста кота лепят из булок и вешают на верёвке под потолок. Игроки по очереди поднимаются к нему на вилах и прыгают, чтобы откусить кусок, а остальные стараются их столкнуть. Кто откусил хвост, тот выиграл. Здесь всё начинается раньше — с печи. Кота сначала надо испечь, и какой выйдет из печи, того и придётся кусать.',
      howLabel: 'Как играть',
      how: [
        'Зажми — и от теста в деже отрывается ком. Чем он больше, тем шире потом укус; маленький и откусить труднее, и в печи он сгорает быстрее.',
        'Дежа одна на все шесть булок. Шестая — хвост, а хвост решает всё. Оставь ему теста.',
        'Отпусти — ком уйдёт в печь. Нажми, когда булка станет золотой. Сырая — тяжёлая и скользкая, подгорелая — широкая и хрусткая, но лёгкая, как пух.',
        'Потом кота вешают, и начинается главное. Тяжёлый кот качается лениво, лёгкий носится как бешеный — и с каждым откушенным куском он становится легче.',
      ],
      start: 'Месить',
      again: 'Ещё раз',
      jump: 'Удерживай, чтобы слепить булку; нажми, чтобы вынуть из печи; нажми, чтобы укусить',
      ...
      shove: 'толкают!',
      sceneAlt:
        'Кот, слепленный из булок, висит на верёвке под потолочной балкой. Под ним парень на вилах, рядом печь и дежа с тестом, вокруг — вся хата.',
      ...
      goal: {
        ...
        bite: 'каждый откушенный кусок — ещё одна попытка на хвост',
      },
      msg: {
      ...
      epilogue: {
        ...
        calendar:
          'А завтра с утра начинается Филиппов пост. Он забирает мясо, а с ним и игры — до самых Колядок.',
        docLabel: 'А что записано на самом деле',
        facts: [
          'Обряд «Ката пячы» внесён в Государственный список историко-культурных ценностей в 2017 году, шифр 33АК000117.',
          'аг. Скірмантава, Дзержинский район.',
          'Хранит его семья Радьковых — коллективы «Сваякі» и «Весялуха», каждый год с 1993-го.',
        ],
        invented:
          'Ганна, Сымон и Алесик — наши. В списке записан обряд, а не люди: имена, споры и все советы придуманы здесь.',
      },
      sourceLabel: 'Источник',
      source:
        'Государственный список историко-культурных ценностей Республики Беларусь, шифр 33АК000117 (внесён в 2017 году): обряд «Ката пячы», аг. Скірмантава Дзержинского района. Хранит его семья Радьковых — коллективы «Сваякі» и «Весялуха», каждый год начиная с 1993-го.',
      honestyLabel: 'Насколько она белорусская',
      honesty:
        'Одна из немногих игр, у которой уникальность не просто заявлена: ни русского, ни украинского, ни польского аналога не нашлось ни под каким названием. Но и обряд этот не общенациональный, а одной деревни. В списке — Скирмантово, и здесь он показан именно так.',
      calendarLabel: 'Почему 27 ноября',
      calendar:
        'Это канун Филиппова поста. Еда в этот вечер нарочно жирная: с утра пост, а он запрещает мясо — и игры вместе с ним.',
      choicesLabel: 'Что мы придумали сами',
      choices:
        'Из записи: кота пекут из булок, вешают под потолок, к нему поднимаются на вилах, остальные толкают, а хвост решает игру. Всё, где есть цифра, — наше: сколько теста в деже, что размер булки значит для укуса, как сырое и горелое меняют качание, сколько попыток даёт хвост. Выпечка здесь — отдельная половина игры, которой в записи нет: там булки просто пекут, за них не состязаются. И трое за столом тоже наши. Ганна, Сымон и Алесик выдуманы, а советуют они наперекор друг другу нарочно: варианты традиции и правда расходятся, и никто из троих не прав больше других.',
      back: 'все игры',
    },
  },
  toy: {
...
export const be: Dictionary = {
  ...
  games: {
    ...
    description:
      'Беларускія народныя гульні, у якія можна згуляць проста ў браўзеры. У кожнай — хто запісаў, дзе і калі, і шчыра: што ў ёй сваё, а што агульнае з суседзямі.',
    lede: 'Народныя гульні, у якія можна згуляць проста тут. Гульняў, якія ёсць толькі ў Беларусі, амаль няма — пра гэта першымі кажуць самі беларускія этнографы. Затое ёсць тое, як гулялі тут: свае словы, свае песні, свае рэчы ў руках і свой дзень у календары.',
    framing:
      'Па механіцы гэтыя гульні шмат у чым агульныя з рускімі, украінскімі і польскімі. Сваё ў іх — мова, песня, начынне і пара года. Такая гісторыя цікавейшая за размовы пра ўнікальнасць, і галоўнае — яна праўдзівая.',
    rulesLabel: 'Тры правілы раздзела',
    rules: [
      'У кожнай гульні названая крыніца: хто запісаў, дзе і калі.',
      'Нічога звыш таго, што ёсць у крыніцах. «Толькі ў Беларусі» сказана толькі там, дзе гэта сказана ў запісе.',
      'Нічога не дадумана моўчкі. Калі запіс маўчыць і лічбу давялося выбраць самім — старонка так і кажа.',
    ],
    ...
    items: [
      {
        ...
        name: '«Ката пячы»',
        gloss:
          'Ката лепяць з булак і вешаюць пад столь. Ты падымаешся да яго на вілах і скачаш, каб адкусіць кавалак, а ўсе навокал цябе штурхаюць. Хто адкусіў хвост — той і выйграў.',
        status: 'live',
      ...
      },
      {
        ...
        name: '«Лянок»',
        gloss:
          'Восем спраў з ільном — браць, малаціць, слаць, мяць, ткаць, беліць, кроіць, шыць — і на кожную свой радок песні, у такт. А палатно ў канцы складзецца ў сапраўдны арнамент.',
        status: 'planned',
      },
      {
        slug: 'pannachka',
        name: '«Панначка»',
        gloss:
          'Дзяўчаты стаяць у коле, у кожнай у руках свечка. Трэба задзьмуць суседчыну і зберагчы сваю. Але ніхто не выбывае: апошні агеньчык ідзе па коле і запальвае ўсе астатнія нанова.',
        status: 'planned',
      },
      {
        slug: 'hrahi',
        name: '«Грахі»',
        gloss:
          'Мяч коцяць уздоўж рада ямак. Схібіў — грэх кладзецца ў тваю ямку, пацэліў — у чужую. А хто носіць на сабе грахі, таму і кідкоў даюць менш: чым больш віны, тым менш права караць.',
        status: 'planned',
      },
      {
        slug: 'zanicba-cyareski',
        name: '«Жаніцьба Цярэшкі»',
        gloss:
          'Калядная гульня ў вяселле — адзіная, якую даследчыкі называюць толькі беларускай. Ты — свацця і зводзіш усю хату ў пары, адну за адной. А вядзе гульню песня: што праспявалі, тое і сталася.',
        status: 'planned',
      },
    ],
    kata: {
      name: '«Ката пячы»',
      gloss: 'ігрышча',
      title: '«Ката пячы» — беларуская гульня: спячы ката і адкусіць хвост',
      description:
        '27 лістапада ў Скірмантаве ката лепяць з булак, вешаюць пад столь і кусаюць з вілаў; хто адкусіў хвост, той выйграў. Тут ката спачатку трэба спячы — і кусаць потым будзеш таго, якога спёк.',
      kicker: '27 лістапада · аг. Скірмантава · Дзяржаўны спіс 33АК000117',
      lede: 'Вечарам напярэдадні посту ката лепяць з булак і вешаюць на вяроўцы пад столь. Гульцы па чарзе падымаюцца да яго на вілах і скачуць, каб адкусіць кавалак, а астатнія стараюцца іх сапхнуць. Хто адкусіў хвост, той выйграў. Тут усё пачынаецца раней — з печы. Ката спачатку трэба спячы, і які выйдзе з печы, таго і давядзецца кусаць.',
      howLabel: 'Як гуляць',
      how: [
        'Зацісні — і ад цеста ў дзяжы адрываецца камяк. Чым ён большы, тым шырэйшы потым укус; малы і адкусіць цяжэй, і ў печы ён згарае хутчэй.',
        'Дзяжа адна на ўсе шэсць булак. Шостая — хвост, а хвост вырашае ўсё. Пакінь яму цеста.',
        'Адпусці — камяк пойдзе ў печ. Націсні, калі булка стане залатой. Сырая — цяжкая і слізкая, падгарэлая — шырокая і хрумсткая, але лёгкая, як пух.',
        'Потым ката вешаюць, і пачынаецца галоўнае. Цяжкі кот гайдаецца ляніва, лёгкі носіцца як шалёны — і з кожным адкушаным кавалкам ён робіцца лягчэйшым.',
      ],
      start: 'Месіць',
      again: 'Яшчэ раз',
      jump: 'Утрымлівай, каб зляпіць булку; націсні, каб выняць з печы; націсні, каб укусіць',
      ...
      shove: 'штурхаюць!',
      sceneAlt:
        'Кот, злеплены з булак, вісіць на вяроўцы пад бэлькай. Пад ім хлопец на вілах, побач печ і дзяжа з цестам, навокал — уся хата.',
      ...
      goal: {
        ...
        bite: 'кожны адкушаны кавалак — яшчэ адна спроба на хвост',
      },
      msg: {
        ...
        baked: '{piece}: {bake}.',
        tailNext: 'Апошняя — хвост, а хвост вырашае ўсё. Цеста засталося: {n}.',
        doughOut: 'Дзяжа пустая — далей лепім з таго, што наскрэблі.',
        hung: 'Кот спечаны і вісіць. Цяпер — кусаць.',
        ready: 'Кусай: {piece}.',
        hit: 'Адкусіў! Кот стаў лягчэйшы, а значыць — хутчэйшы.',
        miss: 'Міма. Гэты кавалак дастаўся іншаму.',
        tail: 'Застаўся хвост. Вяроўка лётае як ніколі. Спробаў: {n}.',
        tailMiss: 'Міма. Засталося спробаў: {n}.',
        win: 'Хвост твой. Гульня твая.',
        lose: 'Хвост дастаўся іншаму. Ну што ж — да наступнага 27 лістапада.',
      },
      advisors: {
        hanna: {
          name: 'Ганна',
      ...
      epilogue: {
        ...
        calendar:
          'А заўтра з раніцы — Піліпаўка. Пост забірае мяса, а з ім і гульні — да самых Каляд.',
        docLabel: 'А што запісана насамрэч',
        facts: [
          'Ігрышча «Ката пячы» ўнесена ў Дзяржаўны спіс гісторыка-культурных каштоўнасцей у 2017 годзе, шыфр 33АК000117.',
          'аг. Скірмантава, Дзяржынскі раён.',
          'Захоўвае яго сям’я Радзькаў — калектывы «Сваякі» і «Весялуха», штогод з 1993-га.',
        ],
        invented:
          'Ганна, Сымон і Алесік — нашы. У спісе запісаны абрад, а не людзі: імёны, спрэчкі і ўсе парады прыдуманы тут.',
      },
      sourceLabel: 'Крыніца',
      source:
        'Дзяржаўны спіс гісторыка-культурных каштоўнасцей Рэспублікі Беларусь, шыфр 33АК000117 (унесена ў 2017 годзе): ігрышча «Ката пячы», аг. Скірмантава Дзяржынскага раёна. Захоўвае яго сям’я Радзькаў — калектывы «Сваякі» і «Весялуха», штогод пачынаючы з 1993-га.',
      honestyLabel: 'Наколькі яна беларуская',
      honesty:
        'Адна з нямногіх гульняў, у якой унікальнасць не проста заяўленая: ні рускага, ні ўкраінскага, ні польскага адпаведніка не знайшлося ні пад якой назвай. Але і абрад гэты не агульнанацыянальны, а адной вёскі. У спісе — Скірмантава, і тут ён паказаны менавіта так.',
      calendarLabel: 'Чаму 27 лістапада',
      calendar:
        'Гэта пярэдадзень Піліпаўкі. Ежа ў гэты вечар знарок тлустая: з раніцы пост, а ён забараняе мяса — і гульні разам з ім.',
      choicesLabel: 'Што мы прыдумалі самі',
      choices:
        'З запісу: ката пякуць з булак, вешаюць пад столь, да яго падымаюцца на вілах, астатнія штурхаюць, а хвост вырашае гульню. Усё, дзе ёсць лічба, — наша: колькі цеста ў дзяжы, што памер булкі значыць для ўкусу, як сырое і гарэлае мяняюць гайданне, колькі спробаў дае хвост. Выпечка тут — асобная палова гульні, якой у запісе няма: там булкі проста пякуць, за іх не спаборнічаюць. І трое за сталом таксама нашы. Ганна, Сымон і Алесік выдуманыя, а раяць яны насуперак адно аднаму знарок: варыянты традыцыі сапраўды разыходзяцца, і ніхто з траіх не мае рацыі больш за іншых.',
      back: 'усе гульні',
    },
  },
  toy: {
